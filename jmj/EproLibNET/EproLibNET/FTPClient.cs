...
namespace com.enterprisedt.net.ftp
{
	...
	internal class FTPClient
	{
		...
		/// </summary>
		internal FTPTransferType TransferType
		{
			get
			{
				return transferType;
		...
		/// the remote hostname 
		/// </param>
		internal FTPClient(string remoteHost)
		{
		...
		/// 
		/// </param>
		internal FTPClient(string remoteHost, int controlPort)
		{
		...
		/// 
		/// </param>
		internal FTPClient(System.Net.IPAddress remoteAddr)
		{
		...
		/// 
		/// </param>
		internal FTPClient(System.Net.IPAddress remoteAddr, int controlPort)
		{
		...
		/// </param>
		internal FTPClient(string remoteHost, StreamWriter log, int timeout)
		{
		...
		/// the length of the timeout, in milliseconds
		/// </param>
		internal FTPClient(string remoteHost, int controlPort, StreamWriter log, int timeout)
		{
		...
		/// </param>
		internal FTPClient(IPAddress remoteAddr, 
		...
		/// the length of the timeout, in seconds		
		/// </param>
		internal FTPClient(System.Net.IPAddress remoteAddr, int controlPort, StreamWriter log, int timeout)
		{
		...
		/// user name
		/// </param>
		internal void User(string user)
		{			
		...
		/// </param>
		internal void Quote(string command, string[] validCodes)
		{			
		...
		/// </param>
		internal void Put(string localPath, string remoteFile)
		{			
		...
		/// name of remote file in current directory		
		/// </param>
		internal void Put(Stream srcStream, string remoteFile)
		{			
		...
		/// </param>
		internal void Put(string localPath, string remoteFile, bool append)
		{			
		...
		/// true if appending, false otherwise 
		/// </param>
		internal void Put(Stream srcStream, string remoteFile, bool append)
		{			
			// get according to set type
			if (TransferType == FTPTransferType.ASCII)
			{
		...
		/// name of remote file in current directory
		/// </param>
		internal void Put(byte[] bytes, string remoteFile)
		{			
		...
		/// 
		/// </param>
		internal void Put(byte[] bytes, string remoteFile, bool append)
		{			
			InitPut(remoteFile, append);
		...
		/// name of remote file in current directory		
		/// </param>
		internal void Get(string localPath, string remoteFile)
		{			
			// get according to set type
			if (TransferType == FTPTransferType.ASCII)
			{
		...
		/// name of remote file in current directory
		/// </param>
		internal void Get(Stream destStream, string remoteFile)
		{
		...
		/// name of remote file in current directory
		/// </param>
		internal byte[] Get(string remoteFile)
		{			
			InitGet(remoteFile);
		...
		/// </returns>
		internal bool Site(string command)
		{
		...
		/// 
		/// </returns>
		internal string[] Dir(string dirname)
		{			
		...
		/// </returns>
		internal string[] Dir(string dirname, bool full)
		{			
			// set up data channel
			data = control.CreateDataSocket(connectMode);
		...
		/// 
		/// </param>
		internal void Delete(string remoteFile)
		{			
		...
		/// </param>
		internal void Rmdir(string dir)
		{			
		...
		/// 
		/// </param>
		internal void Chdir(string dir)
		{			
		...
		/// </returns>
		internal DateTime ModTime(string remoteFile)
		{			
		...
		/// 
		/// </returns>
		internal string Help(string command)
		{			
