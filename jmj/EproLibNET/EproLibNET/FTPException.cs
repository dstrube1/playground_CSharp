...
namespace com.enterprisedt.net.ftp
{
	...
	/// $Revision: 1.1 $
	/// </version>
	internal class FTPException:System.Exception
	{
		/// <summary>   
		...
		/// 
		/// </param>
		internal FTPException(string msg):base(msg)
		{
		}
		...
		/// 
		/// </param>
		internal FTPException(string msg, string replyCode):base(msg)
		{			
