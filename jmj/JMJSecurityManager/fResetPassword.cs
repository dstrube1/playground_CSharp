...
namespace JMJSecurityManager
{
	...
	public class fResetPassword : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.bCancel.Location = new System.Drawing.Point(110, 136);
			...
			this.bOK.Location = new System.Drawing.Point(190, 136);
			this.bOK.Name = "bOK";
			this.bOK.TabIndex = 8;
			this.bOK.Text = "&OK";
		...
		private void bOK_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Admin username cannot be blank.");
				this.DialogResult = DialogResult.Cancel;
			}
